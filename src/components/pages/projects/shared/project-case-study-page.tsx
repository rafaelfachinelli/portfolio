...
type CaseStudyProjectContent = {
  title: string
  hero: {
    eyebrow: string
    subtitle: string
    summary: string
    temporalMarkLabel?: string
    temporalMarkDate?: string
    highlights: string[]
    logoAlt: string
  }
  overview: CaseStudySectionContent
  businessProblem: CaseStudySectionContent
  scopeAndComplexity: CaseStudySectionContent
  myRole: CaseStudySectionContent
  architecture: CaseStudySectionContent
  contributions: CaseStudySectionContent
  challenges: CaseStudySectionContent
  results: CaseStudySectionContent
  learnings: CaseStudySectionContent
  imageCaptions?: {
    overview?: string
    scopeAndComplexity?: string
    results?: string
  }
}
...
type ProjectCaseStudyPageProps = {
  ...
  project: CaseStudyProjectContent
  nextStep: CaseStudyNextStep
  heroLogoSrc: string
  sections?: Partial<
    Record<
      | 'overview'
...
const defaultSectionVisuals: Record<SectionKey, SectionVisual> = {
  overview: {
    icon: Compass,
...
export function ProjectCaseStudyPage({
  ...
  const formattedTemporalMarkDate =
    project.hero.temporalMarkDate && project.hero.temporalMarkLabel
      ? formatTemporalMarkDate(project.hero.temporalMarkDate, lang)
      : null

  const getSectionVisual = (key: SectionKey) => ({
    ...defaultSectionVisuals[key],
    ...sections?.[key],
  })

  const overviewVisual = getSectionVisual('overview')
  const businessProblemVisual = getSectionVisual('businessProblem')
  const scopeAndComplexityVisual = getSectionVisual('scopeAndComplexity')
  const myRoleVisual = getSectionVisual('myRole')
  const architectureVisual = getSectionVisual('architecture')
  const contributionsVisual = getSectionVisual('contributions')
  const challengesVisual = getSectionVisual('challenges')
  const resultsVisual = getSectionVisual('results')
  const learningsVisual = getSectionVisual('learnings')
  ...
  return (
    <PageContent className="gap-6 pb-16">
      ...
      <ProjectCaseStudySection
        icon={overviewVisual.icon}
        iconClassName={overviewVisual.iconClassName}
        title={project.overview.title}
        intro={project.overview.intro}
        paragraphs={project.overview.paragraphs}
        imageSrc={overviewVisual.imageSrc}
        imageAlt={overviewVisual.imageAlt}
        imageCaption={overviewVisual.imageCaption}
      />

      <ProjectCaseStudySection
        icon={businessProblemVisual.icon}
        iconClassName={businessProblemVisual.iconClassName}
      ...
      <ProjectCaseStudySection
        icon={scopeAndComplexityVisual.icon}
        iconClassName={scopeAndComplexityVisual.iconClassName}
        ...
        imageSrc={scopeAndComplexityVisual.imageSrc}
        imageAlt={scopeAndComplexityVisual.imageAlt}
        imageCaption={scopeAndComplexityVisual.imageCaption}
      />

      <ProjectCaseStudySection
        icon={myRoleVisual.icon}
        iconClassName={myRoleVisual.iconClassName}
      ...
      <ProjectCaseStudySection
        icon={architectureVisual.icon}
        iconClassName={architectureVisual.iconClassName}
      ...
      <ProjectCaseStudySection
        icon={contributionsVisual.icon}
        iconClassName={contributionsVisual.iconClassName}
      ...
      <ProjectCaseStudySection
        icon={challengesVisual.icon}
        iconClassName={challengesVisual.iconClassName}
      ...
      <ProjectCaseStudySection
        icon={resultsVisual.icon}
        iconClassName={resultsVisual.iconClassName}
        title={project.results.title}
        intro={project.results.intro}
        paragraphs={project.results.paragraphs}
        items={project.results.items}
        imageSrc={resultsVisual.imageSrc}
        imageAlt={resultsVisual.imageAlt}
        imageCaption={resultsVisual.imageCaption}
      />

      <ProjectCaseStudySection
        icon={learningsVisual.icon}
        iconClassName={learningsVisual.iconClassName}
